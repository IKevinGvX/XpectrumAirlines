...
namespace Xpectrum_Structure.Pages.Profile
{
    ...
    {
        private readonly string _connectionString = "Server=xpectrum.mssql.somee.com;Database=xpectrum;User Id=KKevinyouman2004_SQLLogin_2;Password=Kevinyouman2004;TrustServerCertificate=True;Encrypt=True;MultipleActiveResultSets=True;Connection Timeout=30;"; // Conexi�n a la base de datos
        ...
        public async Task<IActionResult> OnPostAsync(Profile updatedProfile)
        {
            ...
            {
                return Page(); // Si hay errores de validaci�n, regresa a la misma p�gina
            }
            ...
            if (string.IsNullOrEmpty(nombre))
            {
                ...
                return RedirectToPage("/Account/Login"); // Si no est� autenticado, redirige al login
            }
            ...
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                await cmd.ExecuteNonQueryAsync(); // Ejecuta la actualizaci�n
            }

            TempData["SuccessMessage"] = "Perfil actualizado con �xito.";
            return RedirectToPage(); // Redirigir a la misma p�gina con los datos actualizados
        }
        ...
        public class Profile
        {
            ...
            [StringLength(20)]
            public string Telefono { get; set; } // Tel�fono

            [StringLength(255)]
            public string Direccion { get; set; } // Direcci�n
            ...
            [StringLength(255)]
            public string PreferenciasNotificaciones { get; set; } // Preferencias de notificaci�n
        }
    }
}